...
namespace Assignment14_CRUD.Models
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<FaturaDetay> FaturaDetays { get; set; } = null!;
        ...
        public virtual DbSet<VwTopCondimentProduct> VwTopCondimentProducts { get; set; } = null!;
        public virtual DbSet<VwToplamAlisveri> VwToplamAlisveris { get; set; } = null!;
        public virtual DbSet<VwToplamAlisveriss> VwToplamAlisverisses { get; set; } = null!;
        public virtual DbSet<VwUrunlerKategoriSup> VwUrunlerKategoriSups { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Fatura>(entity =>
            {
                ...
                entity.Property(e => e.FaturaKesimTarihi).HasColumnType("smalldatetime");

                entity.Property(e => e.MusId).HasColumnName("MusID");
            });
            ...
            modelBuilder.Entity<FaturaDetay>(entity =>
            {
                ...
                entity.Property(e => e.Tutar)
                    .HasColumnType("money")
                    .HasComputedColumnSql("([Adet]*[BirimFiyat])", false);

                entity.Property(e => e.UrunId).HasColumnName("UrunID");

                entity.HasOne(d => d.Fatura)
                    .WithMany(p => p.FaturaDetays)
                    .HasForeignKey(d => d.FaturaId)
                    .HasConstraintName("FK__FaturaDet__Fatur__2B0A656D");
            });
            ...
            modelBuilder.Entity<VwTopCondimentProduct>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vw_TopCondimentProducts");
            ...
            modelBuilder.Entity<VwToplamAlisveri>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vw_ToplamAlisveris");
            ...
            modelBuilder.Entity<VwToplamAlisveriss>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vw_ToplamAlisveriss");
            ...
            modelBuilder.Entity<VwUrunlerKategoriSup>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vw_UrunlerKategoriSup");
